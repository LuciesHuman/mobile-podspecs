...
Pod::Spec.new do |s|
  ...
  s.source = {
    # :http => "https://github.com/evidentidpublic/mobile-public-podspecs-ios/releases/download/0.5.2/AssureSDK_iOS.zip"
    :http => "https://github.com/LuciesHuman/AssureSDK-iOS_demo/releases/download/0.5.2/AssureSDK_iOS.zip"
  }
